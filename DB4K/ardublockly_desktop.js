...
(function loadJsInElectron(){
  if (Ardublockly.isRunningElectron()) {
	...
	//**********************************************************************
	//Modified by RLQ DB4K  Ardublockly -> DB4K
    window.$ = window.jQuery = require(projectRoot +
        '/DB4K/js_libs/jquery-2.1.3.min.js');
    window.Hammer = require(projectRoot + '/DB4K/js_libs/hammer.min.js');
    window.JsDiff = require(projectRoot + '/DB4K/js_libs/diff.js');
	//-----------------------------------------------------------------------
  }
})();
