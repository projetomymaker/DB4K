...
//***************************************************************************
//modified by RLQ DB4K - > Original: Blockly.FieldAngle.ROUND = 15;
Blockly.FieldAngle.ROUND = 45;
//------------------------------------------------------------------------
/**
 * Half the width of protractor image.
 */
//******************************************************************* 
//modified by RLQ DB4K - > Original: Blockly.FieldAngle.HALF = 100/2;
Blockly.FieldAngle.HALF = 100 / 3;
//-------------------------------------------------------------------
...
Blockly.FieldAngle.prototype.showEditor_ = function() {
  ...
  var svg = Blockly.createSvgElement('svg', {
    ...
    'version': '1.1',
    //******************************************************************************
    //modified by RLQ DB4K - > Original heigh = (Blockly.FieldAngle.HALF * 2) + 'px'	
  ...
  //************************************************************************
   //modified by RLQ DB4K - > Original:  for (var a = 0; a < 360; a += 15) {
...
Blockly.FieldAngle.angleValidator = function(text) {
  ...
  if (n !== null) {
//********************************************************************************
//modified by RLQ DB4K - > Value 360 changed to 181 
    n = n % 181;
//-------------------------------------------------------------------------------	
    if (n < 0) {
      n += 360;
