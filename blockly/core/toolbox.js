...
function changeMenuItensColor(){
		...
		var textomenuLED = document.getElementById(":3.label"); //TextoLED
		var menuMotores=document.getElementById(":5"); //Motores
		var textomenuMotores= document.getElementById(":5.label"); //TextoMotores
		var menuDisplay=document.getElementById(":7"); //Display
		var textomenuDisplay = document.getElementById(":7.label"); //TextoDisplay
		var menuSom=document.getElementById(":9"); //Som
		var textomenuSom = document.getElementById(":9.label"); //TextoSom
	    var menuSensores=document.getElementById(":b"); //Sensores
		var textomenuSensores = document.getElementById(":b.label"); //TextoSensores
		var menuCarrinho=document.getElementById(":d"); //Carrinho
